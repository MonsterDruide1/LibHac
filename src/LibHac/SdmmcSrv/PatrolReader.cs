...
internal class PatrolReader
{
    ...
    private static ReadOnlySpan<byte> PatrolStateKey => // "U{W5>1Kq#Gt`f6r86o`9|*||hTy9U2C\0"
        new[]
        {
            (byte)'U', (byte)'{', (byte)'W', (byte)'5', (byte)'>', (byte)'1', (byte)'K', (byte)'q',
            (byte)'#', (byte)'G', (byte)'t', (byte)'`', (byte)'f', (byte)'6', (byte)'r', (byte)'8',
            (byte)'6', (byte)'o', (byte)'`', (byte)'9', (byte)'|', (byte)'*', (byte)'|', (byte)'|',
            (byte)'h', (byte)'T', (byte)'y', (byte)'9', (byte)'U', (byte)'2', (byte)'C', (byte)'\0'
        };
    ...
    private bool LoadState()
    {
        ...
        try
        {
            Result rc = _sdmmc.GetDeviceMemoryCapacity(out _deviceCapacitySectors, Port.Mmc0);
            if (rc.IsFailure())
            {
                return false;
            }
            ...
            rc = _sdmmc.Read(patrolStateBuffer, Port.Mmc0, BytesToSectors(_patrolStateOffset),
